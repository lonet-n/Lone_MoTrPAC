...
echo ${outdir}/${sample}Aligned.out.bam.junc >> ${outdir}/../junc_path.txt
...
echo ${sample}Aligned.out.bam control >> ${outdir}/../gastrocnemius.txt
...
echo ${sample}Aligned.out.bam one_hour >> ${outdir}/../gastrocnemius.txt
...
echo ${sample}Aligned.out.bam four_hour >> ${outdir}/../gastrocnemius.txt
