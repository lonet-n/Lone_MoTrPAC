...
echo ${sample}_Aligned.out.bam control >> ${outdir}/../gastrocnemius.txt
...
echo ${sample}_Aligned.out.bam one_hour >> ${outdir}/../gastrocnemius.txt
...
echo ${sample}_Aligned.out.bam four_hour >> ${outdir}/../gastrocnemius.txt
