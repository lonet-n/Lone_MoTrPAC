...
echo ${sample}Aligned.out.bam zero_hour >> ${outdir}/../gastrocnemiusc0.txt
...
echo ${sample}Aligned.out.bam half_hour >> ${outdir}/../gastrocnemiusc5.txt
...
echo ${sample}Aligned.out.bam seven_hour >> ${outdir}/../gastrocnemiusc7.txt
...
echo ${sample}Aligned.out.bam twentyfour_hour >> ${outdir}/../gastrocnemiusc24.txt
...
echo ${sample}Aligned.out.bam fortyeight_hour >> ${outdir}/../gastrocnemiusc48.txt
