...
echo ${sample}Aligned.out.bam control >> ${outdir}/../gastrocnemiusc0.txt
...
echo ${sample}Aligned.out.bam one_hour >> ${outdir}/../gastrocnemiusc0.txt
...
echo ${sample}Aligned.out.bam control >> ${outdir}/../gastrocnemiusc5.txt
...
echo ${sample}Aligned.out.bam one_hour >> ${outdir}/../gastrocnemiusc5.txt
...
echo ${sample}Aligned.out.bam one_hour >> ${outdir}/../gastrocnemiusc4.txt
...
echo ${sample}Aligned.out.bam control >> ${outdir}/../gastrocnemiusc7.txt
...
echo ${sample}Aligned.out.bam one_hour >> ${outdir}/../gastrocnemiusc7.txt
...
echo ${sample}Aligned.out.bam control >> ${outdir}/../gastrocnemiusc24.txt
...
echo ${sample}Aligned.out.bam one_hour >> ${outdir}/../gastrocnemiusc24.txt
...
echo ${sample}Aligned.out.bam control >> ${outdir}/../gastrocnemiusc48.txt
...
echo ${sample}Aligned.out.bam one_hour >> ${outdir}/../gastrocnemiusc48.txt
