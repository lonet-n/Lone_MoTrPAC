...
python ${leafcutter}/clustering/leafcutter_cluster.py -j ${outdir}/star_secondpass/junc_paths.txt -r ${outdir}/${intron_prefix}_intron_cluster -m 50 -o ${intron_prefix} -l 50000
